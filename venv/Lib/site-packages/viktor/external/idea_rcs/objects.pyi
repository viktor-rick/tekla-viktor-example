...
class ProjectData(_OpenObject):
    ...
    def __init__(self, *, national_annex: NationalAnnex = ..., fatigue_check: bool = ..., name: str = ..., number: str = ..., description: str = ..., author: str = ..., date: datetime.date = ..., design_working_life: Literal[50, 75, 100] = ...) -> None: ...
...
class _CssComponent(_OpenElementId):
    def __init__(self, id_: int, material: _ReferenceElement, outline: Sequence[Tuple[float, float]], openings: Optional[Sequence[Sequence[Tuple[float, float]]]]) -> None: ...
...
class CheckSectionExtreme(_OpenObject, metaclass=abc.ABCMeta):
    description: Incomplete
    @abstractmethod
    def __init__(self, accidental: LoadingULS = ..., fatigue: FatigueLoading = ..., frequent: LoadingSLS = ..., fundamental: LoadingULS = ..., characteristic: LoadingSLS = ..., quasi_permanent: LoadingSLS = ..., *, description: str): ...

class StandardCheckSectionExtreme(CheckSectionExtreme):
    def __init__(self, *, accidental: LoadingULS = ..., frequent: LoadingSLS = ..., fundamental: LoadingULS = ..., characteristic: LoadingSLS = ..., quasi_permanent: LoadingSLS = ..., fatigue: FatigueLoading = ..., description: str) -> None: ...
...
class CheckSection(_OpenElementId, ABC, metaclass=abc.ABCMeta):
    ...
    def create_extreme(self, *, description: str = ..., accidental: LoadingULS = ..., fatigue: FatigueLoading = ..., frequent: LoadingSLS = ..., fundamental: LoadingULS = ..., characteristic: LoadingSLS = ..., quasi_permanent: LoadingSLS = ...) -> None: ...
